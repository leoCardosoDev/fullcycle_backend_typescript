...
import { SearchParams, SortDirection } from '../../../domain/repository/search_params'
...
implements ISearchableRepository<E, EntityId, Filter> {
  ...
  protected applyPaginate (items: E[], page: SearchParams['page'], per_page: SearchParams['page']) {
    const start = ( page - 1 ) * per_page
    const limit = start + per_page
    return items.slice(start, limit)
  }

  protected applySort (items: E[], sort: string | null, sort_dir: SortDirection | null, 
